<template>
  <div class="app-container">
   <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-select v-model="dbValue" size="mini" placeholder="切换数据源" @change="handleSwitchDb">
...
<script>
import { delTable, genCode, listDb, listTable, previewTable, switchDb, synchDb } from '@/api/tool/gen'

      ...
      <el-col :span="24" :xs="24">
        <el-header>
          ...
          >
            ...
            <el-form-item prop="disposalUserName">
              <el-input
                v-model="queryParams.disposalUserName"
                placeholder="处置人"
                clearable
                style="width: 240px"
              />
        ...
        <!-- <div class="tableTitle">余料处置信息</div> -->
        <el-table
          :data="materialHandleList"
          border
          :header-cell-style="{
            background: '#eef1f8',
            height: '45px',
...
import { listRemain } from "@/api/cmms/itr/work-order/material.api";
export default {
  ...
  methods: {
    /** 查询列表 */
    async getList() {
      await listRemain(this.queryParams).then((response) => {
        this.materialHandleList = response.data.rows;

  ...
  <div class="app-container">
    <el-row :gutter="24">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-row>
          ...
          >
            ...
            <el-form-item prop="createTimer">
              <el-date-picker
                v-model="queryParams.createTimer"
                type="daterange"
                range-separator="至"
            ...
            <el-form-item prop="transactionDate">
              <el-date-picker
                v-model="queryParams.transactionDate"
                type="daterange"
                range-separator="至"
                start-placeholder="事务处理开始日期"
                style="width: 320px !important"
                end-placeholder="事务处理结束日期"
                value-format="yyyy-MM-dd"
              >
              </el-date-picker>
            </el-form-item>
        ...
        <!-- <el-tag effect="dark" type="danger" style="margin: 0 15px 15px 0">成本总预算：12</el-tag> -->
        <!-- <el-tag effect="dark" type="danger">质保总成本：12</el-tag> -->

        <!-- <div class="tableTitle">物料申请明细</div> -->
        <el-table
          :data="materialList"
          border
          :header-cell-style="{
...
import { listApply } from "@/api/cmms/itr/work-order/material.api";
export default {
  ...
  methods: {
    /** 查询列表 */
    async getList() {
      await listApply(this.queryParams).then((response) => {
    ...
    async handleQuery() {
      ...
      if (this.queryParams?.createTimer?.length) {
        this.queryParams.startTime = this.queryParams.createTimer[0];
        this.queryParams.endTime = this.queryParams.createTimer[0];
      }
      await this.getList();
    },
    /** 重置按钮操作 */

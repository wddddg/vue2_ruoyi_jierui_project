<template>
  <div class="upload-file">
    ...
    >
      <!-- 上传按钮 -->
      <jereh-button slot="trigger" icon="el-icon-upload2" :disabled="disabled">{{ buttonName }}</jereh-button>
      <!-- 自定义功能按钮 -->
      <el-button size="mini" type="primary" v-if="isShowOther" style="margin-left: 10px;" @click="clickOther" :icon="otherButtonIcon" :plain="isPlain">
        {{ this.otherButtonName }}
      </el-button>
      <!-- 上传提示 -->
